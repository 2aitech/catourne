...
const translations = {
  fr: {
    ...
    home: {
      ...
      gridInfiniteLabel: "Nos categories",
      gridInfiniteHeading: "Des opportunites dans tous les secteurs du media",
      gridInfiniteAccent: "media",
  ...
  en: {
    ...
    home: {
      ...
      gridInfiniteLabel: "Our categories",
      gridInfiniteHeading: "Opportunities across all media sectors",
      gridInfiniteAccent: "media",
  ...
  ar: {
    ...
    home: {
      ...
      gridInfiniteLabel: "فئاتنا",
      gridInfiniteHeading: "فرص في جميع قطاعات الإعلام",
      gridInfiniteAccent: "الإعلام",
